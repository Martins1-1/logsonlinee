  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 py-24 md:py-28 max-w-4xl">
        ...
        <Card className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl shadow-xl border border-gray-200 dark:border-gray-800">
          <CardHeader className="border-b border-gray-100 dark:border-gray-800 pb-6">
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-xl bg-green-100 dark:bg-green-900/30">
                <FileText className="h-8 w-8 text-green-600 dark:text-green-400" />
              </div>
              <CardTitle className="text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-blue-600 dark:from-green-400 dark:to-blue-400">
                RULES @ Logs Online
              </CardTitle>
            </div>
          </CardHeader>
          <CardContent className="p-6 md:p-8 space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <p>
              When buying a product on the Logs Online website, you automatically agree to the following rules:
            </p>

            <div className="space-y-4">
              <section>
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Warranty Period</h3>
                <p>The warranty on the product is 30 minutes from the date of purchase, subject to compliance with all rules and conditions for working with accounts. This means that if you experience problems with your account within the first 30 minutes after purchase and you have followed all instructions and rules, Logs Online guarantees a replacement or a refund.</p>
              </section>

              <section>
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">No Returns for Valid Accounts</h3>
                <p>A purchased valid item cannot be returned or replaced. If you purchased an account that is valid and functional but later changed your mind, Logs Online will not provide a return or replacement. Please read the product description carefully before purchasing.</p>
              </section>

              <section>
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Refund When Replacement Is Not Possible</h3>
                <p>If accounts cannot be replaced, Logs Online will refund the amount paid. This applies in situations where accounts cannot be replaced for any reason (for example, if they are deleted or blocked).</p>
              </section>

              <section>
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Account Security Responsibility</h3>
                <p>If you plan to use purchased accounts for a long time, you must regularly change passwords and take responsibility for account security. Logs Online is not responsible for any security-related issues after purchase.</p>
              </section>

              <section>
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Product Description Awareness</h3>
                <p>Before buying, carefully read the product description and check its characteristics to ensure it meets your needs. Logs Online provides detailed product descriptions, and customers are responsible for reviewing them before purchase.</p>
              </section>

              <section>
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Technical Support</h3>
                <p>If you experience any problems with your order, contact Logs Online technical support as soon as possible. Technical support responds within 24 hours of contact.</p>
              </section>

              <section>
                <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">No Training or Usage Consultation</h3>
                <p>Logs Online does not provide training or advice on how to use accounts. The store is only responsible for providing operational accounts and does not offer guidance on usage. For usage-related questions, please consult external resources or experts.</p>
              </section>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800">
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-100 dark:border-blue-800">
                  <h4 className="font-bold text-blue-800 dark:text-blue-300 mb-2">Use High-Quality Proxy Servers</h4>
            ...
            <div className="mt-6 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg text-sm text-gray-600 dark:text-gray-400 italic">
              <span className="font-bold not-italic">Important Notice:</span> Logs Online is not responsible for third-party developers of programs, services, or proxy providers. All accounts registered by Logs Online or its partners are created using private software, programs that are not available to the public, and proxy servers.
            </div>
          </CardContent>
        </Card>
      </div>
