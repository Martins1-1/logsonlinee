                              ...
                              <CardContent className="p-0">
                                <div className="flex flex-col md:flex-row md:items-center gap-0 md:gap-4 md:p-4">
                                  ...
                                  <div className="px-3 pb-3 md:hidden">
                                    <p className="text-xs text-gray-600 dark:text-gray-400 line-clamp-4">{product.description}</p>
                                  </div>

                                  {/* Desktop Layout: Description, Price, Button */}
                                  <div className="hidden md:flex md:items-center md:gap-4 md:flex-1">
                                    <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-4 flex-1">{product.description}</p>
