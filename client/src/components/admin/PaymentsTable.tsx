          ...
          <tbody>
            {payments.map((p) => (
              <tr key={p._id} className="border-t border-gray-200 dark:border-gray-800 hover:bg-blue-50/50 dark:hover:bg-gray-800/50 transition-colors">
                ...
                <td className="p-3 md:p-4 text-sm md:text-base text-gray-800 dark:text-gray-200 truncate max-w-[150px]">{p.user?.email || "—"}</td>
                <td className="p-3 md:p-4 text-sm md:text-base text-gray-800 dark:text-gray-200 font-semibold">₦{p.amount}</td>
                <td className="p-3 md:p-4 text-sm md:text-base text-gray-800 dark:text-gray-200">{p.method}</td>
